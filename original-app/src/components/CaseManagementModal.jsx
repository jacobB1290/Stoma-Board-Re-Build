...
export const CaseManagementModal = ({ show, onClose, stage, stageStats }) => {
  ...
  const processedCases = useMemo(() => {
    ...
    stageStats.caseDetails.forEach((caseDetail) => {
      ...
      // Handle outliers
      if (caseDetail.isOutlier && !isManuallyExcluded) {
        // Add outliers to excluded with proper metadata
            ...
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-xl font-bold">
                  {stage.charAt(0).toUpperCase() + stage.slice(1)} Stage - Case
                  Management
                </h2>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-center">
                          {isExcluded ? (
                            <button
                              onClick={() => handleToggleExclusion(caseData.id)}
                              disabled={loading}
